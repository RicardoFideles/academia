<div class="faixas view">
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1><?php echo __('Faixa'); ?></h1>
			</div>
		</div>
	</div>
					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
									<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp;Edit Faixa'), array('action' => 'edit', $faixa['Faixa']['id']), array('escape' => false)); ?> </li>
		<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete Faixa'), array('action' => 'delete', $faixa['Faixa']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $faixa['Faixa']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Faixas'), array('action' => 'index'), array('escape' => false)); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Faixa'), array('action' => 'add'), array('escape' => false)); ?> </li>
...
<div class="related row">
	...
	<thead>
	<tbody>
	<?php foreach ($faixa['Competitor'] as $competitor): ?>
		<tr>
